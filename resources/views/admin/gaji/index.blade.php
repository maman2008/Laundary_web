        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 rounded shadow-sm">
                ...
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.payroll.create') }}" class="inline-flex items-center px-4 py-2 bg-emerald-600 text-white rounded-md text-sm hover:bg-emerald-700">Tambah Payroll</a>
                </div>
